An editorial news feed displaying player updates and articles, resembling a high-end financial news publisher. Specific for ADMIN users.
...
2. **Header Band:** "Player News Network" (Weight 400).
   - **Admin Feature:** Include a secondary button "Create News Article" next to the heading.
