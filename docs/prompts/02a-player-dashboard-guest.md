An editorial-style dashboard showing a list of soccer players with search and filtering capabilities, specifically for GUEST users.
...
1. **Top Navigation:** 
   ...
   - Right: Show a "Sign In" outline pill button.
...
5. **Footer:** Use the `BottomTabsGuest` component (defined separately), setting the "Players" tab as active.