...
describe('SpringPlayerProvider', () => {
  ...
  describe('searchPlayers', () => {
    it('should search players via GET with encoded name', () => {
      ...
      const req = httpMock.expectOne(
        'http://localhost:8080/players-service/players/search/John%20Doe',
      );
      expect(req.request.method).toBe('GET');
      req.flush(mockPlayers);
  ...
  describe('updatePlayer', () => {
    it('should PATCH an existing player', () => {
      ...
      const req = httpMock.expectOne('http://localhost:8080/players-service/players/1');
  ...
  describe('importPlayer', () => {
    it('should POST to import a player and return full response', () => {
      ...
      const req = httpMock.expectOne(
        'http://localhost:8080/players-service/players/import/99',
      );
      expect(req.request.method).toBe('POST');
